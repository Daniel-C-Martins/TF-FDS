...
/**
 * UpdateCost é uma classe de caso de uso responsável por atualizar o custo
 * mensal de um aplicativo.
...
public class UpdateCostUC {
    ...
    * 
    * @param applicativeService O serviço de aplicativos usado para realizar a
    ...
    * @throws IllegalArgumentException Se o aplicativo não existir ou se o novo
    *                                  custo for inválido.
    */
   public ApplicativeDTO run(double newCost, Long id) {
      ...
      // Atualiza o custo mensal do aplicativo
